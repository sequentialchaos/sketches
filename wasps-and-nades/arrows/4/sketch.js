...
function draw() {
  ...
  // rotate(PI / 2)
  drawShapes(drawThing2, s, c.n, (shiftUp + angleAddition + easeInOutQuart(numPhases * (t % (1 / numPhases))) / numPhases) * TWO_PI)
}
...
function drawArcs(s) {
  arc(0, 0, s, s, -PI * 0.54, PI * 0.54)
  arc(s, 0, s, s, PI * 0.46, -PI * 0.46)
}
